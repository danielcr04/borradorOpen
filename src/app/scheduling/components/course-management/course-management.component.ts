...
import { Course } from "../../model/course.entity";  // Importa el modelo de Course
import { FormsModule, NgForm } from "@angular/forms";  // Usamos FormsModule para formularios
import { MatFormField } from "@angular/material/form-field";  // Para Material Form Field
import { MatButton } from "@angular/material/button";  // Para el botón de Material
import { MatInput } from "@angular/material/input";  // Para los campos de entrada de Material
import { BaseFormComponent } from '../../../shared/components/base-form.component';  // Base para formularios
...
export class CourseManagementComponent extends BaseFormComponent {
  //#region Attributes
